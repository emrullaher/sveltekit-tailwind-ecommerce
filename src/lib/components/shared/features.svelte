		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
			<div>
				<svg
					...
					class="fill-teal-700 dark:fill-white"
				>
					<path
				...
				<h1 class="mt-4 text-xl font-semibold text-teal-700 dark:text-white">
			...
			<div>
				...
				<h1 class="mt-4 text-xl font-semibold text-teal-700 dark:text-white">Express Shipping</h1>

				<p class="mt-2 text-gray-500 dark:text-gray-400">
					Say goodbye to long waits! This product comes with express shipping options to get your
					order to you in record time. It's the ultimate choice for those who need their items ASAP
				</p>
			</div>
			...
			<div>
				...
				<p class="mt-2 text-gray-500 dark:text-gray-400">
					Elevate your customer experience to unparalleled levels with our Premium Support Package.
					This product is meticulously crafted to not only meet but exceed your customers'
					expectations.
				</p>
			</div>
		</div>
