<section class="bg-gray-800 py-10 dark:bg-gray-900">
	<div class="container mx-auto flex flex-col items-center px-4 py-12 text-center">
		<h2 class="text-2xl font-bold capitalize tracking-tight text-white xl:text-3xl">
			Explore the best shopping deals with our mobile app
		</h2>

		<p class="mt-4 block max-w-4xl text-gray-500 dark:text-gray-300">
			Discover a world of incredible shopping deals and discounts with the FakeStore app. Get access
			to a wide range of products from various categories at unbeatable prices. Shop smarter, save
			more, and enjoy a seamless shopping experience right at your fingertips. Download the
			FakeStore app now and start saving today!
		</p>

		<div class="mt-6">
			<a
				class="inline-flex w-full items-center justify-center overflow-hidden rounded-lg bg-teal-700 px-4 py-2.5 text-sm text-white shadow transition-colors duration-300 hover:bg-teal-900 focus:ring focus:ring-gray-300 focus:ring-opacity-80 dark:bg-gray-800 dark:hover:bg-gray-700 sm:mx-2 sm:w-auto"
